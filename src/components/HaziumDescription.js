  ...
  return (
    <div className="col-md-12">
      <div className="well">
        ...
        <p>
          This dataset is a table that as items have each of the registers of a sensor that measure the chemical concentration in the air, the building have 4 sensors and the attributes of the table are:
        </p>
        <ul>
          <li>
            <strong>Timestamp:</strong> Sequential ordinal attribute tha contains the date and value in the moment of the measurement of the sensor.
          </li>
          <li>
          ...
          <li>
            <strong>Sensor:</strong> Categorical attribute that indicates what sensor do the measurement, this value codify the floor and the zone that the sensor is ubicated.
          </li>
        </ul>
        <h1>
          WHY
        ...
        <p>
          The measurements in the second floor presente a pretty close trends, so this observation makes the before idea of reducin the sensor to the third floor more relevant, this indicates that the concentration in the second floow is almost the same in every zone.
        </p>
        <p>
          There are two spikes in the visualization, in friday 03 and saturday 11, the last one spike is really interesting, it shows a significant increase on the chemical concentration, this event happens approximately at midday usually when the workers leave the building.
        </p>
        <p>
